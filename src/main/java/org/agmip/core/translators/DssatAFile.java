 ...
 * @version 1.0
 */
public class DssatAFile implements WeatherFile {
    ...
    /**
     * DSSAT Observation Data Input method
     * 
     * @author Meng Zhang
     * @version 0.1
        ...
        try {
            ...
            for (int i = 0; i < (titleOutputId.length / 40 + titleOutputId.length % 40 == 0 ? 0 : 1); i++) {
                ...
                for (int j = i * 40; j < limit; j++) {
                    br.write(titleOutput.get(titleOutputId[j]).toString());
                }
                br.write("\r\n");
